...
class _UnusedAuthRepoDomain implements AuthRepoDomain {
  ...
  @override
  Future<Result<Null, Object>> resendOtp({required String email, required OtpPurpose purpose}) {
    // TODO: implement resendOtp
    throw UnimplementedError();
  }

  @override
  Future<Result<AuthEntity, Object>> verifyOtp({required String email, required String otp, required OtpPurpose purpose}) {
